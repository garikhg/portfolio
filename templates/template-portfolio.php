    ...
    <div class="portfolio-projects">
        <div class="portfolio-filter flex gap-2 pb-5" data-filter="portfolio" data-filter-paged="true">
            ...
            <ul class="portfolio-filter__list flex gap-2">
                <li class="flex items-center gap-1 is-active"><a href="#all" data-category-count="15"
                                                                 class="text-link"><span>All</span><sup>15</sup></a></li>
                <li class="flex items-center gap-1"><a href="#apps" data-category-count="3" class="text-link"><span>Apps</span> <sup>3</sup></a>
                </li>
                <li class="flex items-center gap-1"><a href="#branding" class="text-link"><span>Branding</span> <sup>4</sup></a></li>
                <li class="flex items-center gap-1"><a href="#creative" class="text-link"><span>Creative</span> <sup>1</sup></a></li>
                <li class="flex items-center gap-1"><a href="#identity" class="text-link"><span>Identity</span> <sup>5</sup></a></li>
                <li class="flex items-center gap-1"><a href="#mockup" class="text-link"><span>Mockup</span> <sup>2</sup></a></li>
            </ul>
        </div>
                                ...
                                <div class="show-project mt-2">
                                    ...
                                    <div class="show-project__link text-white font-semibold">
                                        <a href="#" class="text-link text-link-foreground">
                                            <span><?php esc_html_e( 'Show project', 'portfolio' ); ?></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
