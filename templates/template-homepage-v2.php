...
<div class="page-content mt-20">
    <section class="portfolio-projects full-max-width bg-background py-20">
        <div class="container">
            <div class="grid grid-cols-3 -mx-4">
                <div class="col-span-1 px-4">
                    <div class="bg-light-gray rounded-2xl p-6 h-full">
                        <h2 class="section-title text-4xl font-heading font-bold">
                            Services
                        </h2>
                        <span class="divider "></span>
                        <p class="text-lg font-light">
                            Set of outstanding and creative layouts along with endless design options will bring your
                            showcase to the highest level.
                        </p>
                    </div>
                </div>
                <div class="col-span-2 px-4">
                    <div class="grid grid-cols-3 -mx-5 gap-y-20">
                        <div class="px-5">
                            <div class="hover:bg-light-gray transition-all duration-150 p-5 rounded-lg">
                                <div class="icon-holder w-16 h-16 inline-flex items-center justify-center bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 rounded-full overflow-hidden p-0.5 mb-5">
                                    <div class="bg-background w-full h-full inline-flex items-center justify-center rounded-full">
                                        <i class="icon-figma text-3xl"></i>
                                        <span class="sr-only">Figma</span>
                                    </div>
                                </div>
                                <h5 class="text-xl font-heading font-semibold">Develop bespoke interactive
                                    eLearning</h5>
                                <p class="mt-3 font-light">Immerse your learners with bespoke interactive eLearning
                                    solutions.</p>
                            </div>
                        </div>
                        <div class="px-5">
                            ...
                            <h5 class="text-xl font-heading font-semibold">Develop bespoke interactive eLearning</h5>
                            <p class="mt-3 font-light">Immerse your learners with bespoke interactive eLearning
                                solutions.</p>
                        </div>
                        <div class="px-5">
            ...
            <div class="grid grid-cols-3 -mx-4 mt-24">
                <div class="col-span-1 px-4">
                ...
                <div class="col-span-2 px-4">
                    <div class="slider-outer-end -mr-[20vw]">
